# Powiązania osoby | API | Rejestr.io
...
- _aktualne_ - Powiązania aktualne, występujące w najnowszych wpisach do KRS.
- _historyczne_ - Powiązania historyczne, czyli takie, które istniały w przeszłości, ale nie występują w najnowszych wpisach do KRS.
